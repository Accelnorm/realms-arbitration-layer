...
import DisputeSafeMigrateToSafe from './components/instructions/DisputeSafe/MigrateToSafe'
import DisputeSafeQueuePayout from './components/instructions/DisputeSafe/QueuePayout'
import DisputeSafeChallengePayout from './components/instructions/DisputeSafe/ChallengePayout'
import DisputeSafeRecordRuling from './components/instructions/DisputeSafe/RecordRuling'
import DisputeSafeReleasePayout from './components/instructions/DisputeSafe/ReleasePayout'
import DisputeSafeExitFromCustody from './components/instructions/DisputeSafe/ExitFromCustody'
...
const New = () => {
  ...
  const instructionMap: {
    ...
    () => ({
      ...
      [Instructions.DisputeSafeMigrateToSafe]: DisputeSafeMigrateToSafe,
      [Instructions.DisputeSafeQueuePayout]: DisputeSafeQueuePayout,
      [Instructions.DisputeSafeChallengePayout]: DisputeSafeChallengePayout,
      [Instructions.DisputeSafeRecordRuling]: DisputeSafeRecordRuling,
      [Instructions.DisputeSafeReleasePayout]: DisputeSafeReleasePayout,
      [Instructions.DisputeSafeExitFromCustody]: DisputeSafeExitFromCustody,
    }),
