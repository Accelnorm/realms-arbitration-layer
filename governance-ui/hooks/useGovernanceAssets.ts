  ...
  const instructionsMap: InstructionsMap = {
    ...
    */
    ...
    /*
      ...
      ██████  ██ ███████ ██       ██████     ██    ███████     ███████ ██   ██ ██      ███████
    */
    [Instructions.DisputeSafeMigrateToSafe]: {
      name: 'Migrate to Safe',
      isVisible: canUseAnyInstruction,
      packageId: PackageEnum.DisputeSafe,
    },
    [Instructions.DisputeSafeQueuePayout]: {
      name: 'Queue Payout',
      isVisible: canUseAnyInstruction,
      packageId: PackageEnum.DisputeSafe,
    },
    [Instructions.DisputeSafeChallengePayout]: {
      name: 'Challenge Payout',
      isVisible: canUseAnyInstruction,
      packageId: PackageEnum.DisputeSafe,
    },
    ...
    [Instructions.DisputeSafeReleasePayout]: {
      name: 'Release Payout',
      isVisible: canUseAnyInstruction,
      packageId: PackageEnum.DisputeSafe,
    },
    [Instructions.DisputeSafeExitFromCustody]: {
      name: 'Exit from Custody',
      isVisible: canUseAnyInstruction,
      packageId: PackageEnum.DisputeSafe,
    },
  }
