...
export class AccountTypeDisputeSafe implements AssetAccount {
  governance: GovernanceProgramAccountWithNativeTreasuryAddress
  type: AccountType
  extensions: AccountExtension
  pubkey: PublicKey
  constructor(
    ...
    this.governance = governance
    this.pubkey = safePolicyAddress
    this.type = AccountType.DISPUTE_SAFE
    this.extensions = {
      disputeSafe: safeConfig,
      transferAddress: safePolicyAddress,
    }
  }
}
